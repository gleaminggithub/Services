    ...
    console.log(room);
      ...
      const handleBookNowClick =async()=>{
        ...
        try {
            ...
            if (data.completed) {
              console.log("success");
              router.push(`/users/${data.session.user.id}`);
            } else {
                ...
                <div className='md:grid md:grid-cols-12 gap-10 px-3'>
                    <div className='md:col-span-8 md:w-full'>
                        <div>
                            ...
                            <div className='mb-11'>
                                <h1 className='font-bold text-3xl mb-2'>Safety And Hygiene</h1>
                                <div className='grid grid-cols-2'>
                                    ...
                                    <div className='flex items-center my-1 md:my-0'>
                                        ...
                                        <p className='ml-2 md:text-base text-xs'>Disinfections and Steriliazations</p>
                                    </div>
                                    <div className='flex items-center my-1 md:my-0'>
                                        <GiSmokeBomb />
                            ...
                            <div className='shadow dark:shadow-white rounded-lg p-6'>
                                <div className='items-cenetr mb-4'>
